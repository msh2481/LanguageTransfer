...
For this dataset the parameters are `max_len=20, vocab_size=40`. A few examples of sampled data:
```
<14 14> <18 18> <1 1> <12 12> <5 5>
<13 <3 3> <4 4> 13>
<2 <2 <14 14> 2> 2> <13 13> <8 <8 <15 <9 9> <20 20> 15> 8> 8>
<11 11> <3 3> <6 6> <9 9>
```

== nested
For the main version of nested dependencies dataset I follow @papadimitriou2023injecting and set `max_len=512, vocab_size=500`, and generate approximately $10^9$ tokens in total.
